...
# TEMPORARY DEBUG — remove after confirming keys are visible
    ...
    st.sidebar.markdown("<p style='color:white; font-size:25px; font-weight:600; margin:4px 0 10px 0; letter-spacing:0.3px;'>Wisdom Mining</p>", unsafe_allow_html=True)
